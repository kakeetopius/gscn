...
func DiscoverCmd() *cobra.Command {
	...
	discoverCmd.Flags().StringVarP(&targetStr, "targert", "t", "", "IP address(es) of the host to scan.")
	...
	discoverCmd.Flags().BoolVarP(&resolveHostnames, "hostnames", "H", false, "Carry out a reverse lookup on the IP addresses discovered on the network to get their host names")
